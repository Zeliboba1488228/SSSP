...
ent-ClothingHeadHatBeretHoS = берет директора ОВД
    .desc = Черный берет с вышитой командирской эмблемой. Для офицеров, которые предпочитают стиль безопасности.
ent-ClothingHeadHatBeretWarden = берет инспектора
    .desc = Фирменный голубой берет с эмблемой инспектора. Для офицеров, которые предпочитают стиль безопасности.
...
ent-ClothingHeadHatHoshat = фуражка директора милиции
